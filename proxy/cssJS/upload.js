                            ...
                            if (typeof j['error'] !== undefined && j['error'] === 'E_HASH') {
                                ...
                                if (data_name == j['filename']) {
                                    ...
                                    if (j['percent'] == 100) {
                                        ...
                                        setTimeout(() => {
                                            // sessionStorage.setItem("fileObject", j['filename']);
                                            // let host = window.location.href;
                                            // window.location.replace(host + "process.php");
                                            document.querySelector("#form").lastElementChild.setAttribute("value", j['filename']);
